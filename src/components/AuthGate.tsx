...
function LoginScreen() {
  ...
  return (
    <div className="flex h-full items-center justify-center overflow-y-auto bg-[var(--color-brand-dark)] p-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex flex-col items-center text-center">
          <AccordionArt className="h-20 w-auto" />
        ...
        <div className="rounded-xl bg-surface p-5 shadow-xl">
          {signedUp ? (
